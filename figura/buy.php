...
$backurl="https://www.facebook.com/teta28com/";  // На какую страничку переходит после отправки письма 
...
$msg=" 
Меня зовут $name и я бронирую в Ранний список по Фигуре.
...
fwrite($f," \n $date $time Ранний список Фигура - $name"); 
...
<p style=\"font-family:'PT Sans'; font-size: 36px; font-weight:700; text-align:center;\">Спасибо! Вы успешно зарегистрировались в Ранний список. Подробности мы напишем на почту</p>
</div>";  
exit; 
